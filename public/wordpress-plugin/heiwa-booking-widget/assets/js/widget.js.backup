...
(function($) {
    ...
    window.HeiwaBookingWidget = {
        ...
        // Legacy/shim methods for external callers
        toggleWidget: function() {
            try { toggleWidget(); } catch (e) { console.warn('toggleWidget shim failed', e); }
        },
        openModal: function() {
            try { openWidget(); } catch (e) { console.warn('openModal shim failed', e); }
        },
        closeModal: function() {
            try { closeWidget(); } catch (e) { console.warn('closeModal shim failed', e); }
        },
