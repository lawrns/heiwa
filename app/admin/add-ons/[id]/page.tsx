...
import { ArrowLeft, Package, Euro, Users, Calendar, Save, Trash2 } from 'lucide-react'
...
export default function EditAddOnPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    // TODO: Fetch add-on data from API
    ...
    setTimeout(() => {
      setFormData({
        ...
        imageUrl: '/images/add-ons/surfboard.jpg',
        detailedDescription: 'Professional surfboard rental including wetsuit and leash. Boards are regularly maintained and suitable for all skill levels.'
      })
      setLoading(false)
    }, 1000)
  }, [params.id])
  ...
  const handleSave = (e: React.FormEvent) => {
    e.preventDefault()
    // TODO: Implement actual API call to update add-on
    console.log('Updating add-on:', formData)
  ...
  const handleDelete = () => {
    ...
    // TODO: Implement actual API call to delete add-on
    console.log('Deleting add-on:', params.id)
    router.push('/admin/add-ons')
  }

  const handleInputChange = (field: keyof AddOn, value: any) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('maxQuantity', e.target.value ? parseInt(e.target.value) : undefined)}
                  min="1"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-accent focus:border-accent"
